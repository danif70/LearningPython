...
class Pizza():
    def __init__(self):
        ...
        self.extra = ['Pimentón','Tofu', 'Pepperoni', 'Jamón', 'Salmón', 'mozzarella', 'tomate']
    def __str__(self):
    ...
    def ingrediente_extra(self):
        ingextra = int(input('¿Desea un extra en su pizza? Si: 1 No: 2')
        if ingextra == 1
            i = int(input('Escoge uno entre los siguientes extras: pimiento(1), tofu(2), pepperoni(3), jamón(4), salmón(5), mozzarella(6), tomate(7): '))
